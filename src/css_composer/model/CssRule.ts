...
export default class CssRule extends Styleable {
  ...
  ensureSelectors(m?: any, c?: any, opts?: any) {
    ...
    this.stopListening(this, "change:selectors", this.ensureSelectors);
    ...
    this.listenTo(this, "change:selectors", this.ensureSelectors);
  }
  ...
  compare(
    ...
    const sel =
      selectors instanceof Selectors
        ? selectors.models
        : !isArray(selectors)
        ? [selectors]
        : selectors;
